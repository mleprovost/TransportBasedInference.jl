...
@test  TransportMap.component(C, 1).ξk == zeros(2+2)
@test  TransportMap.component(C, 1).σk == ones(2+2)
@test  TransportMap.component(C, 1).ak == zeros(2+3)
...
@test  TransportMap.component(C, 5).ξk == zeros(2+2)
@test  TransportMap.component(C, 5).σk == ones(2+2)
@test  TransportMap.component(C, 5).ak == zeros(2+3)
