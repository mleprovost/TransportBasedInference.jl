...
@testset "Center and standard deviations of a sample" begin
    ...
    @test norm(S.C[1].ξ[1] - [-0.8432, -0.52845, 0.39565, 1.40675])<1e-10
    @test norm(S.C[2].ξ[1] - [-0.8279166666666666, 0.44464999999999993])<1e-10
    @test norm(S.C[2].ξ[2] - [-0.37235, -0.07175, 0.54285, 0.86355])<1e-10



    @test norm(S.C[1].σ[1] -  [0.9442499999999999, 1.858275, 2.9028, 3.0332999999999997])<1e-10
    @test norm(S.C[2].σ[1] - [3.8177, 3.8177])<1e-10
    @test norm(S.C[2].σ[2] - [0.9018000000000002, 1.3728, 1.4029500000000001, 0.9621])<1e-10
end
